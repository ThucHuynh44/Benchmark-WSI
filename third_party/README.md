...
CoMEL-OWLoRA, LWSR, MICIL, and QPMIL-VL. These files exist only for provenance
and algorithm comparison. ConSlide runtime code must not import them.
...
CoMEL-OWLoRA, MICIL, and QPMIL-VL carry additional
`INTERNAL_RESEARCH_ONLY.md` notices. Review the upstream license or absence of
a license before copying, modifying, sharing, or publishing any derived
implementation.

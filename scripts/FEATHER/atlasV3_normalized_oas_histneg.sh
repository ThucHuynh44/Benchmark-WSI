#!/bin/bash
#SBATCH --job-name=atlasV3NormHist
#SBATCH --output=logs/FEATHER/atlasV3NormHist_%j.out
#SBATCH --error=logs/FEATHER/atlasV3NormHist_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Hoan thanh hai ATLAS-v3 ACL normalized OAS-LDA HistNeg settings."

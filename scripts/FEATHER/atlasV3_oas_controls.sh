#!/bin/bash
#SBATCH --job-name=atlasV3OASCtrl
#SBATCH --output=logs/FEATHER/atlasV3OASCtrl_%j.out
#SBATCH --error=logs/FEATHER/atlasV3OASCtrl_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "FOLDS=$FOLDS"
echo "WARNING: atlasv3_acl_oas_oracle revisits old train splits only for statistics and is diagnostic-only."
...
echo "Hoan thanh ATLAS-v3 ACL OAS controls."

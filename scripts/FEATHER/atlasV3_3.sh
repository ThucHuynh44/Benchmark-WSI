#!/bin/bash
#SBATCH --job-name=atlasV3ACL_3
#SBATCH --output=logs/FEATHER/atlasV3ACL_3_%j.out
#SBATCH --error=logs/FEATHER/atlasV3ACL_3_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1

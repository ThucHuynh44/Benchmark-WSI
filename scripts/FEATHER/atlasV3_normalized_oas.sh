#!/bin/bash
#SBATCH --job-name=atlasV3NormOAS
#SBATCH --output=logs/FEATHER/atlasV3NormOAS_%j.out
#SBATCH --error=logs/FEATHER/atlasV3NormOAS_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Hoan thanh hai ATLAS-v3 ACL normalized OAS-LDA settings."

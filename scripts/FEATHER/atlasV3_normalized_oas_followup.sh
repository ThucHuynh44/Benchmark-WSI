#!/bin/bash
#SBATCH --job-name=atlasV3NormNext
#SBATCH --output=logs/FEATHER/atlasV3NormNext_%j.out
#SBATCH --error=logs/FEATHER/atlasV3NormNext_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Hoan thanh ATLAS-v3 normalized OAS follow-up pilot."
